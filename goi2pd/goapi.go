...
// #cgo LDFLAGS: -L${SRCDIR}/../ -l:i2pd/libi2pdwrapper.a -l:i2pd/libi2pd.a -l:i2pd/libi2pdlang.a -latomic -lcrypto -lssl -lz -lboost_system -lboost_date_time -lboost_filesystem -lboost_program_options -lpthread -lstdc++
//
// #include <stdlib.h>
